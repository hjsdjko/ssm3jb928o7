<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0 25%","textAlign":"center","background":"none","display":"block","width":"50%","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"22px","color":"#333","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"padding":"0px","fontSize":"inherit","color":"inherit","background":"none","display":"inline-block","order":"10"}'>
		  ...
		  <div class="top-el-dropdown-menu-2" :style='{"fontSize":"14px","alignItems":"center","color":"#555","justifyContent":"center","display":"flex"}'>
