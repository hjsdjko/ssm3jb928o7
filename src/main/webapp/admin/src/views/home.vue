<template>
<div class="content" :style='{"padding":"0px 20px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230831/a5f221858a6744baab19924fb77cee81.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"100%"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"width":"100%","margin":"30px auto 40px","fontSize":"22px","color":"rgb(51, 51, 51)","textAlign":"center","fontWeight":"500"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- statis -->
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 30px 30px 0px","alignItems":"center","color":"#666","flexWrap":"wrap","background":"none","display":"flex","width":"250px","fontSize":"14px","justifyContent":"center","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7e8f8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('yuangong','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#ced0ed","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{yuangongCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>员工总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7f8f8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('xiangmuxinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#ceeded","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{xiangmuxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>项目信息总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7f8e8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('hetongxinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#ceedd0","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{hetongxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>合同信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"420px","order":"10"}'>
		<div id="yuangongChart1" class="echarts1" v-if="isAuth('yuangong','首页统计')"></div>
		<div id="xiangmuxinxiChart1" class="echarts2" v-if="isAuth('xiangmuxinxi','首页统计')"></div>
		<div id="hetongxinxiChart1" class="echarts3" v-if="isAuth('hetongxinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		this.yuangongChat1();
		this.getxiangmuxinxiCount();
		this.xiangmuxinxiChat1();
		this.gethetongxinxiCount();
		this.hetongxinxiChat1();
	},
	methods:{
		// 词云
        ...
        this.$http({
            url: "yuangong/typeStat/xingbie/bumen",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    yAxis1.push(parseFloat((res[i].男)));
                    yAxis2.push(parseFloat((res[i].女)));
                    pArray.push({
                        name: res[i].xingbie
                    })
                }
		...
		getxiangmuxinxiCount() {
			this.$http({
				url: `xiangmuxinxi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.xiangmuxinxiCount = data.data
				}
			})
		},
		xiangmuxinxiChat1() {
        ...
        var xiangmuxinxiChart1 = echarts.init(document.getElementById("xiangmuxinxiChart1"),'macarons');
        this.$http({
            url: "xiangmuxinxi/group/xiangmujindu",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].xiangmujindu);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].xiangmujindu
                    })
                }
                var option = {};
                ...
                // 使用刚指定的配置项和数据显示图表。
                xiangmuxinxiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    xiangmuxinxiChart1.resize();
                };
            }
        });
      })
		...
		gethetongxinxiCount() {
			this.$http({
				url: `hetongxinxi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.hetongxinxiCount = data.data
				}
			})
		},
		hetongxinxiChat1() {
        ...
        var hetongxinxiChart1 = echarts.init(document.getElementById("hetongxinxiChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                hetongxinxiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    hetongxinxiChart1.resize();
                };
            }
        });
      })
...
<style lang="scss" scoped>
	...
	// 日历
	.calendar td .text {
				border: 1px solid rgba(93, 213, 200, .2);
				border-radius: 0px;
				flex-direction: column;
				color: rgba(66, 188, 175, 1);
	...
	.calendar td.festival .text {
				border: 1px solid rgba(93, 213, 200, .1);
				border-radius: 0px;
				flex-direction: column;
				color: rgba(66, 188, 175, 1);
